...
var scheduleTournaments = function() {
  ...
  if(countNA == 0) {
    ...
    Tournaments.insert({
      startDate: moment().tz('America/Los_Angeles').add(1, 'days').hour(20).minute(5).second(0).toDate(),
      endRegister: moment().tz('America/Los_Angeles').add(1, 'days').hour(20).minute(0).second(0).toDate(),
  ...
  if(countEU == 0) {
    // schedule an upcoming tournament
    Tournaments.insert({
      startDate: moment().tz('Europe/Berlin').add(1, 'days').hour(20).minute(5).second(0).toDate(),
      endRegister: moment().tz('Europe/Berlin').add(1, 'days').hour(20).minute(0).second(0).toDate(),
      tournamentName: 'Weekly ManTracker.co Tournament',
      tournamentDescription: 'Fight to the death in our ManTracker hosted weekly tournament. Every week, players will fight to win by joining the weekly tournament and earning points when they win. Play now!',
      slots: 64,
      region: 'europe',
  ...
  if(countOCN == 0) {
    // schedule an upcoming tournament
    Tournaments.insert({
      startDate: moment().tz('Australia/Sydney').add(1, 'days').hour(20).minute(5).second(0).toDate(),
      endRegister: moment().tz('Australia/Sydney').add(1, 'days').hour(20).minute(0).second(0).toDate(),
      tournamentName: 'Weekly ManTracker.co Tournament',
      tournamentDescription: 'Fight to the death in our ManTracker hosted weekly tournament. Every week, players will fight to win by joining the weekly tournament and earning points when they win. Play now!',
      slots: 64,
      region: 'oceania',
